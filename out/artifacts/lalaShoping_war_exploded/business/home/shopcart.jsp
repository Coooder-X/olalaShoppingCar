...
<div class="am-container header">
    ...
    <ul class="message-r">
        ...
        <div class="topMessage my-shangcheng">
            <div class="menu-hd MyShangcheng"><a href="/business/frame.html" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a>
            </div>
        </div>
...
<%--                                <label for="J_CheckBox_170037950254"></label>--%>
                            ...
                            <div class="item-pic">
                                <a href="#" target="_blank" data-title="美康粉黛醉美东方唇膏口红正品 持久保湿滋润防水不掉色护唇彩妆"
                                   class="J_MakePoint" data-point="tbcart.8.12">
                                    <img src="/business/images/kouhong.jpg_80x80.jpg" class="itempic J_ItemImg"></a>
                            </div>
                            <div class="item-info">
                        ...
                        <li class="td td-op">
                            <div class="td-inner">
                                <a title="移入收藏夹" class="btn-fav" name="item"   href="/cntApi/purchase.do">
                                    移入收藏夹</a>
                                <a href="/cntApi/delete.do"  data-point-url="#" class="delete">
                                    删除</a>
                            </div>
                        </li>
                    </ul>
