		...
		<div class="am-container header">
			...
			<ul class="message-r">
				...
				<div class="topMessage favorite">
					<div class="menu-hd"><a href="/business/person/collection.html" target="_top"><i class="am-icon-heart am-icon-fw"></i><span>收藏夹</span></a></div></div>
			</ul>
			</div>
...
<%--									<span class="fl">松子</span>--%>
									<span class="total fl">搜索到<strong class="num"><strong><%=list.size()%></strong>件相关商品</span>
								</p>
								<div class="clear"></div>
								...
								<%
									for(CtmGoodsinfos it : list) {
										if(it.getParentId().equals("1") || it.getParentId().equals("-1")) {
								%>
										 <div class="dd-conent">										
											<dd class="select-all selected"><a href="#">全部</a></dd>
											<dd><a href="#"><%=it.getCategoryName()%></a></dd>
										 </div>
									</dl>
								</li>
								<%
...
<%--										<img src="/business/images/cp.jpg" />--%>
...
<%--								<li>--%>
<%--									<div class="i-pic check">--%>
<%--										<img src="/business/images/cp2.jpg" />--%>
				...
				<div id="wrap">
					...
					<div class="quick_toggle">
						...
						<li class="qtitem">
							...
							<div class="mp_qrcode" style="display:none;"><img src="/business/images/weixin_code_145.png" /><i class="icon_arrow_white"></i></div>
						</li>
						<li class="qtitem">
