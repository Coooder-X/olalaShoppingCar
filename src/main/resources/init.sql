...
CREATE TABLE `c_balance_log` (
  ...
  `CUSTOMER_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户ID',
  `SOURCE` tinyint(1) NOT NULL COMMENT '记录来源：1下订单，2退货单',
  `SOURCE_SN` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '相关单据号',
  `AMOUNT` int DEFAULT NULL COMMENT '变动余额',
  `FROZEN_MONEY` int DEFAULT '0' COMMENT '被冻结的金额',
  `CREATE_TIME` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '记录生成时间',
  `CHANGE_DESC` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '消费记录说明',
...
CREATE TABLE `c_collect` (
  `COLLECT_ID` int NOT NULL AUTO_INCREMENT COMMENT '商品收藏ID',
  `GOODS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品主键ID',
  `BUSINESS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '店铺主键ID',
...
CREATE TABLE `c_consignee` (
  `CUSTOMER_ADDR_ID` int NOT NULL AUTO_INCREMENT COMMENT '自增主键ID',
  `CUSTOMER_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '消费者主键ID',
  ...
  `DISTRICT` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '城市中的区域',
  `ADDRESS` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '地址 具体到门牌号',
...
CREATE TABLE `c_customer_info` (
  `CUSTOMER_INF_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '消费者信息详情主键ID',
  `CUSTOMER_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '消费者主键ID',
  `CUSTOMER_NAME` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '消费者用户名',
  `REAL_NAME` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '消费者真实姓名',
  `IDENTY_CATRD_TYPE` tinyint(1) NOT NULL COMMENT '证件类型：1 身份证，2 军官证，3 护照',
  `IDENTY_CATRD_NO` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '证件号码',
  `USER_MOBILE` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '手机号',
  ...
  `BIRTHDAY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '生日',
  ...
  `USER_BALANCE` int DEFAULT NULL COMMENT '用户余额（分）',
...
CREATE TABLE `c_level_info` (
  `CUSTOMER_LEVEL_ID` int NOT NULL AUTO_INCREMENT COMMENT '会员级别ID',
  `LEVEL_NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '会员级别名称',
  `MIN_POINT` int DEFAULT '50' COMMENT '该级别最低积分',
  `MAX_POINT` int DEFAULT '100' COMMENT '该级别最高积分',
...
CREATE TABLE `c_login` (
  `CUSTOMER_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '客户主键ID',
  `LOGIN_NAME` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '登录用户名',
  `PASSWORD` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '登录密码(加密）',
...
CREATE TABLE `c_login_log` (
  `LOGIN_ID` bigint NOT NULL AUTO_INCREMENT COMMENT '登录日志主键ID',
  `CUSTOMER_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '消费者ID',
...
CREATE TABLE `c_point_log` (
  `POINT_ID` bigint NOT NULL AUTO_INCREMENT COMMENT '积分记录主键ID',
  `CUSTOMER_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '消费者主键ID',
  `SOURCE` tinyint(1) NOT NULL COMMENT '积分来源：0订单，1登陆，2活动',
  `REFER_NUM` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '积分来源相关编号',
  `CHARGE_POINT` int DEFAULT NULL COMMENT '变更积分数',
  `RANK_POINTS` int DEFAULT '0' COMMENT '等级积分,跟消费积分是分开的',
  `PAY_POINTS` int DEFAULT '0' COMMENT '消费积分,跟等级积分是分开的',
...
CREATE TABLE `g_activit` (
  `ACTIVIT_ID` smallint NOT NULL AUTO_INCREMENT COMMENT '活动ID',
  `SLOGAN` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '活动主题标语',
  `ACTIVIT_IMG` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '活动图片',
  `ACTIVIT_CONTENT` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '活动内容文字说明',
  `LINK_URL` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '跳转链接地址',
  `SORT_ORDER` tinyint DEFAULT NULL COMMENT '活动排序',
...
-- ----------------------------
INSERT INTO `g_activit` VALUES ('1', '个人护理蝴蝶节', null, '个人护理蝴蝶节,最高满199减100', null, '0', '2020-07-06 18:10:36', '2020-07-06 18:10:36', '0', '2020-07-06 18:10:36', 'admin', '2020-07-06 18:10:36', 'admin');
INSERT INTO `g_activit` VALUES ('2', '宠物选美季', null, '宠物选美季，每天一元秒', null, '1', '2020-07-06 18:10:36', '2020-07-06 18:10:36', '0', '2020-07-06 18:10:36', 'admin', '2020-07-06 18:10:36', 'admin');
INSERT INTO `g_activit` VALUES ('3', '开学了', null, '开学了，吃点好吃的', null, '2', '2020-07-06 18:10:36', '2020-07-06 18:10:36', '0', '2020-07-06 18:10:36', 'admin', '2020-07-06 18:10:36', 'admin');
INSERT INTO `g_activit` VALUES ('4', '保鲜专家', null, '保鲜专家，给家人购幸福', null, '3', '2020-07-06 18:10:36', '2020-07-06 18:10:36', '0', '2020-07-06 18:10:36', 'admin', '2020-07-06 18:10:36', 'admin');
...
CREATE TABLE `g_advers` (
  `ADVER_ID` smallint NOT NULL AUTO_INCREMENT COMMENT '广告ID',
  `TITLE` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '广告主题',
  `ADVER_TYPE` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '广告类别',
  `ADVER_IMG` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '轮播图片',
  `ADVER_CONTENT` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '广告的文字内容',
  `LINK_URL` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '跳转链接地址',
  `SORT_ORDER` tinyint DEFAULT NULL COMMENT '轮播排序',
  ...
  `LINK_MAN` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '广告联系人',
  `LINK_EMAIL` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '广告联系人的邮箱',
  `LINK_PHONE` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '广告联系人的电话',
  `CLICK_COUNT` mediumint DEFAULT NULL COMMENT '该广告点击数',
...
-- Records of g_advers
-- ----------------------------
INSERT INTO `g_advers` VALUES ('1', '由内而外爱自己', '1', '', '由内而外爱自己', null, '0', '2020-07-06 18:07:38', '2020-07-06 18:07:38', null, null, null, null, '1', '1', '2020-07-06 18:07:38', 'admin', '2020-07-06 18:07:38', 'admin');
INSERT INTO `g_advers` VALUES ('2', '吃货联盟，3.8折起', '1', null, '吃货联盟，3.8折起', null, '1', '2020-07-06 18:07:38', '2020-07-06 18:07:38', null, null, null, null, '1', '1', '2020-07-06 18:07:38', 'admin', '2020-07-06 18:07:38', 'admin');
INSERT INTO `g_advers` VALUES ('3', '鲜货直达', '1', null, '鲜货直达', null, '2', '2020-07-06 18:07:39', '2020-07-06 18:07:39', null, null, null, null, '1', '1', '2020-07-06 18:07:39', 'admin', '2020-07-06 18:07:39', 'admin');
INSERT INTO `g_advers` VALUES ('4', '以肉换肉，节后甩肉', '1', null, '以肉换肉，节后甩肉', null, '3', '2020-07-06 18:07:40', '2020-07-06 18:07:40', null, null, null, null, '1', '1', '2020-07-06 18:07:40', 'admin', '2020-07-06 18:07:40', 'admin');
...
CREATE TABLE `g_business` (
  `BUSINESS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '店铺ID',
  `BUSINESS_NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '店铺名称',
  `BUSINESS_CODE` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '店铺代码',
  `ADDRESS` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '店铺的地址',
  `SEND_RANGE` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '配送范围',
  `FANS_COUNT` int DEFAULT '0' COMMENT '店铺的粉丝数',
  `SCORE` int DEFAULT NULL COMMENT '店铺评分 整存',
  `BUSINESS_LEVEL` tinyint(1) DEFAULT NULL COMMENT '店铺等级',
  `BUSINESS_TYPE` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '店铺类型 ',
  `TERMINAL_CODE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '设备终端编码',
...
CREATE TABLE `g_busi_coup` (
  `BUSI_RED_COUP_ID` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `COUPON_ID` int NOT NULL COMMENT '优惠券主键ID',
  `BUSINESS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '店铺主键ID',
  PRIMARY KEY (`BUSI_RED_COUP_ID`),
  KEY `FK_BUSINESSID_R` (`BUSINESS_ID`) USING BTREE,
  KEY `FK_REDPICKETID_B` (`COUPON_ID`) USING BTREE,
  CONSTRAINT `g_busi_coup_ibfk_1` FOREIGN KEY (`BUSINESS_ID`) REFERENCES `g_business` (`business_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `g_busi_coup_ibfk_2` FOREIGN KEY (`COUPON_ID`) REFERENCES `g_coupon` (`COUPON_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `g_category` (
  ...
  `PARENT_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '0' COMMENT '分类父级ID   默认-1为一级分类',
  `KEYWORDS` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '分类编码   名称简拼，用于快捷页面跳转',
  `CATY_DESC` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品分类描述',
  `SORT_ORL` int DEFAULT NULL COMMENT '商品分类排序',
  `IS_SHOW_IN_NAV` tinyint(1) DEFAULT '0' COMMENT '是否显示在导航栏,0不;1显示',
  `GRADE` tinyint DEFAULT '1' COMMENT '该分类的最高和最低价之间的价格分级,当大于1时,会根据最大最小价格区间分成区间,会在页面显示价格范围,如0-300,300-600,600-900这种;',
  `FILTER_ATTR` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '如果该字段有值,则该分类将还会按照该值对应在表goods_attr的goods_attr_id所对应的属性筛选，如，封面颜色下有红，黑分类筛选',
...
CREATE TABLE `g_categ_busi` (
  `CATY_BUSI_ID` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `BUSINESS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '店铺主键ID',
  `CATEGORY_ID` int DEFAULT NULL COMMENT '商品分类主键ID',
  `PARENT_CATEG_ID` int DEFAULT NULL COMMENT '父级分类ID',
  PRIMARY KEY (`CATY_BUSI_ID`),
  KEY `FK_BUSINESSID_C` (`BUSINESS_ID`) USING BTREE,
  KEY `FK_CATEGORYID_B` (`CATEGORY_ID`) USING BTREE,
  CONSTRAINT `g_categ_busi_ibfk_1` FOREIGN KEY (`BUSINESS_ID`) REFERENCES `g_business` (`BUSINESS_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `g_categ_busi_ibfk_2` FOREIGN KEY (`CATEGORY_ID`) REFERENCES `g_category` (`category_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `g_coupon` (
  `COUPON_ID` int NOT NULL AUTO_INCREMENT COMMENT '优惠券主键ID',
  `COUPON_SN` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '优惠券编号',
  `TITLE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '优惠券主题',
  `FACE_VALUE` int NOT NULL COMMENT '优惠券面值',
  `SEND_TYPE` tinyint DEFAULT NULL COMMENT '优惠券发送类型0按用户如会员等级,会员名称发放;1按商品类别发送;2按订单金额所达到的额度发送;3线下发送',
  `MIN_AMOUNT` int DEFAULT NULL COMMENT '如果按金额发送优惠券,需满足的最小金额,即只要购买超过该金额的商品都可以领到红包',
  `MAX_AMOUNT` int DEFAULT NULL COMMENT '如果按金额发送优惠券,需满足的最大金额',
  ...
  `MIN_BUY_AMOUNT` int DEFAULT NULL COMMENT '可以使用该优惠券的商品的最低价格,即只要达到该价格商品才可以使用红包',
  `COUNT` int DEFAULT '0' COMMENT '优惠券总个数',
  `TAKED_COUNT` int DEFAULT '0' COMMENT '已被领取的优惠券个数',
  `CREATE_TIME` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `CREATE_BY` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '创建者',
  `UPDATE_TIME` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `UPDATE_BY` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '更新者',
...
CREATE TABLE `g_discount` (
  `DISCOUNT_ID` smallint NOT NULL AUTO_INCREMENT COMMENT '折扣ID',
  `GOODS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品ID',
  `BUSINESS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '店铺ID',
  `USER_RANK` tinyint DEFAULT NULL COMMENT '会员等级',
  `DISC_VALUE` int DEFAULT NULL COMMENT '折扣',
  `MIN_AMOUNT` int DEFAULT NULL COMMENT '如果按金额计算折扣,需满足的最小金额',
  `MAX_AMOUNT` int DEFAULT NULL COMMENT '如果按金额计算折扣,需满足的最大金额',
  `MIN_BUY_COUNT` int DEFAULT NULL COMMENT '如果按计件计算折扣,需满足的最小件数',
...
CREATE TABLE `g_goods` (
  `GOODS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品ID',
  `GOODS_SN` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品的唯一货号',
  `GOODS_NAME` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品名称',
  `KEYWORDS` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品关键字，放在商品页的关键字中，为搜索引擎收录用',
  `CATY_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品分类ID',
  `CATY_SN` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品分类编码',
  `BUSINESS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '所属店铺ID',
  `EFFECTIVE_DATE` datetime DEFAULT NULL COMMENT '生产日期',
  `EXPIRY_DAYS` int DEFAULT '0' COMMENT '有效期(天)',
  `GOODS_BRIEF` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品的简短描述',
  `GOODS_DESC` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '商品的详细描述',
  `MARKET_PRICE` int DEFAULT NULL COMMENT '市场售价(分)',
  `DISCOUNT` int DEFAULT '100' COMMENT '折扣',
  `SHOP_PRICE` int DEFAULT NULL COMMENT '本店售价(分)',
  `PROMOTE_PRICE` int DEFAULT NULL COMMENT '促销价格（分）',
  ...
  `SHIP_FEE` int DEFAULT '0' COMMENT '快递费（分）',
...
CREATE TABLE `g_goods_brand` (
  ...
  `CATEGORY_ID` int DEFAULT NULL COMMENT '品牌类别ID',
  `BRAND_LOGO` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '上传的该品牌Logo图片',
  `BRAND_DESC` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '品牌描述',
  `SITE_URL` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '品牌的网址',
  `SORT_ORL` tinyint DEFAULT NULL COMMENT '品牌在前台页面的显示顺序,数字越大越靠后',
  `IS_SHOW` tinyint DEFAULT '1' COMMENT '该品牌是否显示;0否1显示',
...
CREATE TABLE `g_goods_extends` (
  `GOODS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品ID',
  `EXTEND1` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '扩展字段1',
  `EXTEND2` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '扩展字段2',
  `EXTEND3` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '扩展字段3',
  `EXTEND4` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '扩展字段1',
  `EXTEND5` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '扩展字段5',
  `EXTEND6` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '扩展字段6',
  KEY `FK_GOODS_E` (`GOODS_ID`) USING BTREE,
  CONSTRAINT `g_goods_extends_ibfk_1` FOREIGN KEY (`GOODS_ID`) REFERENCES `g_goods` (`GOODS_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `g_goods_param` (
  `GOODS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品ID',
  `BRAND_ID` smallint DEFAULT NULL COMMENT '品牌ID',
  `FOOD_TASTE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '食物的口味',
  `WEIGHT` float(10,0) DEFAULT NULL COMMENT '商品重量',
  `LENGTH` float(10,0) DEFAULT NULL COMMENT '商品长度',
  `SIZE` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '尺码',
  `COLOR` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '颜色',
  `PACKAGE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '包装',
  `STORAGE_TYPE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '储藏方式',
  `SOURCE_ADDR` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '原料产地',
  `PRODUCE_ADDR` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '产地',
  `INGREDIENTS` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '配料、原料',
  `SPECS` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '规格（g）',
  `PRO_STANDARD` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '产品标准号',
  `PRO_LICENSE_NO` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '生产许可证编号',
  `EAT_METHOD` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '食用方法',
  `CLICK_COUNT` int DEFAULT '0' COMMENT '商品的点击数',
  `IS_ALONESALE` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否能单独销售，1，是；0，否；如果不能单独销售，则只能作为某商品的配件或者赠品销售',
  `INTEGRAL` int DEFAULT '0' COMMENT '购买该商品可以使用的积分数量',
  ...
  `BONUS_TYPE_ID` int DEFAULT NULL COMMENT '购买该商品所能领到的优惠券类型',
  `SELLER_NOTE` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品的商家备注，仅商家可见',
  `GIVE_INTEGRAL` int NOT NULL DEFAULT '-1' COMMENT '购买该商品时每笔成功交易赠送的积分数量',
  KEY `FK_GOODSID_P` (`GOODS_ID`) USING BTREE,
  CONSTRAINT `g_goods_param_ibfk_1` FOREIGN KEY (`GOODS_ID`) REFERENCES `g_goods` (`GOODS_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `g_goods_report` (
  `GOODS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品主键ID',
  `MONTH_SALES` int DEFAULT '0' COMMENT '月销量',
  `COUNT_SALES` int DEFAULT '0' COMMENT '总销量',
  `COUNT_COMMS` int DEFAULT '0' COMMENT '总评价数',
  `COMMEND_SCORE` int DEFAULT '0' COMMENT '评分',
  PRIMARY KEY (`GOODS_ID`),
  CONSTRAINT `g_goods_report_ibfk_1` FOREIGN KEY (`GOODS_ID`) REFERENCES `g_goods` (`GOODS_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `g_news` (
  `NEWS_ID` smallint NOT NULL AUTO_INCREMENT COMMENT '新闻ID',
  `TITLE` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '新闻标题',
  `TYPE` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '新闻类别',
  `SORT_ORL` int DEFAULT NULL COMMENT '新闻排序',
  `CONTENT` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '新闻内容',
  `LINK_URL` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '新闻链接地址',
  `IS_ENABLED` tinyint(1) DEFAULT '1' COMMENT '是否有效  1有效 0 无效',
  `CREATE_TIME` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `CREATE_BY` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '创建者',
  `UPDATE_TIME` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `UPDATE_BY` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '更新者',
  PRIMARY KEY (`NEWS_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='商城头条新闻表';

-- ----------------------------
-- Records of g_news
-- ----------------------------
INSERT INTO `g_news` VALUES ('1', '洋河年末大促，低至两件五折', '特惠', '0', '洋河年末大促，低至两件五折', null, '1', '2020-07-06 18:00:19', 'admin', '2020-07-06 18:00:19', 'admin');
INSERT INTO `g_news` VALUES ('2', '商城与广州市签署战略合作协议', '公告', '1', '商城与广州市签署战略合作协议', null, '1', '2020-07-06 17:59:01', 'admin', '2020-07-06 17:59:01', 'admin');
INSERT INTO `g_news` VALUES ('3', '女生节商城爆品1分秒', '特惠', '2', '女生节商城爆品1分秒', null, '1', '2020-07-06 17:59:02', 'admin', '2020-07-06 17:59:02', 'admin');
INSERT INTO `g_news` VALUES ('4', '华北、华中部分地区配送延迟', '公告', '3', '华北、华中部分地区配送延迟', null, '1', '2020-07-06 17:59:03', 'admin', '2020-07-06 17:59:03', 'admin');
INSERT INTO `g_news` VALUES ('5', '家电狂欢千亿礼券 买1送1！', '特惠', '4', '家电狂欢千亿礼券 买1送1！', null, '1', '2020-07-06 17:59:04', 'admin', '2020-07-06 17:59:04', 'admin');
INSERT INTO `g_news` VALUES ('6', '618购物狂欢，全场购物券通用', '特惠', '5', '618购物狂欢，全场购物券通用', null, '1', '2020-07-06 17:59:05', 'admin', '2020-07-06 17:59:05', 'admin');
...
CREATE TABLE `g_picture` (
  `PICTURE_ID` bigint NOT NULL AUTO_INCREMENT COMMENT '图片主键ID',
  `GOODS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品主键ID',
  `BUSINESS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商家主键ID',
  `PIC_DESC` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '图片描述',
  `THUMB_IMG` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品在前台显示的微缩图片，如在分类筛选时显示的小图片',
  `REAL_IMG` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品的实际大小图片，如进入该商品页时介绍商品属性所显示的大图片',
  `ORIGINAL_IMG` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品的原始图片',
  `LINK_URL` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '图片超链接地址',
  `WIDTH` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '图片宽度',
  `HEIGHT` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '图片高度',
  `SORT_ORL` int DEFAULT NULL COMMENT '图片排序',
...
CREATE TABLE `g_second_sales` (
  `SECOND_SALE_ID` smallint NOT NULL AUTO_INCREMENT COMMENT '秒杀活动主键ID',
  `GOODS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品主键ID',
  `MAX_SEC` int DEFAULT '300' COMMENT '秒杀时长（s）',
  `SALE_COUNT` int DEFAULT '0' COMMENT '已售数量',
  `MAX_COUNT` int DEFAULT '0' COMMENT '秒杀数量',
  `SALE_PRICE` int DEFAULT NULL COMMENT '秒杀价格(分)',
...
CREATE TABLE `o_comment` (
  `COMMENT_ID` bigint NOT NULL AUTO_INCREMENT COMMENT '评论主键ID',
  `COMMENT_TYPE` tinyint NOT NULL DEFAULT '0' COMMENT '用户评论的类型; 0评论的是商品,1评论的是文章',
  `ID_VALUE` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品/文章主键ID',
  `ORDER_ID` bigint DEFAULT NULL COMMENT '订单ID',
  `USER_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户ID',
  `USER_NAME` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户名',
  `EMAIL` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '评论者邮箱',
  `TITLE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '评论主题',
  ...
  `IP_ADDR` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '评论者的IP地址',
  `PARENT_ID` int DEFAULT NULL COMMENT '评论的父节点,取值该表的comment_id字段,如果该字段为0,则是一个普通评论,否则该条评论就是该字段的值所对应的评论的回复',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品订单评论表';
...
CREATE TABLE `o_delivery` (
  `DELIV_NO` int NOT NULL AUTO_INCREMENT COMMENT '配送单编码',
  `SHIP_SN` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '快递单号',
  `SHIP_COMP_NAME` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '快递公司名称',
  `CUSTOMER_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '客户主键ID',
  `ORDER_SN` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '订单编号',
  `GOODS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品主键ID',
  `QUANTITY` int DEFAULT NULL COMMENT '商品数量',
  `UNIT_PRICE` int DEFAULT NULL COMMENT '商品单价',
  `TOTAL_PRICE` int DEFAULT NULL COMMENT '订单总价',
  `DELIV_FEE` int DEFAULT NULL COMMENT '配送费用（分）',
  `CUST_NAME` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '收件人姓名',
  `ZIP` char(6) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '收货地址邮编',
  `PROVINCE` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '省份',
  `CITY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '城市',
  `DISTRICT` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '城市中的区域',
  `ADDRESS` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '收货地址',
  `TEL_NO` char(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '收货人联系方式',
...
CREATE TABLE `o_order_detail` (
  ...
  `GOODS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '订单商品ID',
  `GOODS_NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品名称',
  `GOODS_CNT` int DEFAULT NULL COMMENT '购买商品数量',
  `GOODS_PRICE` int DEFAULT NULL COMMENT '购买商品单价（分）',
  `AVERAGE_COST` int DEFAULT NULL COMMENT '平均成本价格（分）',
  `WEIGHT` float DEFAULT NULL COMMENT '商品重量',
  `DISTRICT_MONEY` int DEFAULT NULL COMMENT '优惠分摊金额（分）',
  `WHID` int DEFAULT NULL COMMENT '仓库ID',
  `MODIFIED_TIME` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
...
CREATE TABLE `o_order_master` (
  ...
  `TRANSATION_NO` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '交易流水号',
  `CUSTOMER_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '客户ID',
  ...
  `ORDER_MONEY` int DEFAULT NULL COMMENT '订单金额（分）',
  `DISTRICT_MONEY` int DEFAULT NULL COMMENT '优惠金额（分）',
  `PAY_MONEY` int DEFAULT NULL COMMENT '支付金额（分）',
  `CREATE_TIME` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '下单时间',
  `RECEIVE_TIME` datetime DEFAULT NULL COMMENT '收货时间',
  `ORDER_STATUS` tinyint DEFAULT '0' COMMENT '订单状态 0未支付 1已支付 2已完成 3待退款 4已退款 5已关闭',
  `ORDER_POINT` int DEFAULT NULL COMMENT '订单积分',
  `INVOICE_TITLE` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发票抬头',
  `INVOICE_NO` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发票单号',
  `MODIFIED_TIME` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
...
CREATE TABLE `o_refund_order` (
  `REFUND_ORDER_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '退货单编号',
  `CUSTOMER_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '客户ID',
  `ORDER_ID` int NOT NULL COMMENT '原始订单ID',
  `TRANSATION_NO` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '交易流水号',
  `DELIV_FEE` int DEFAULT NULL COMMENT '配送费用（分）',
  `DELIV_DATE` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '配送日期',
  `REFUND_REASON` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '退货原因',
  `GOODS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品ID',
  `QUANTITY` int DEFAULT NULL COMMENT '商品数量',
  `CUST_NAME` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '退货人',
...
CREATE TABLE `o_shop_cart` (
  `SHOP_CART_ID` bigint NOT NULL AUTO_INCREMENT COMMENT '购物车ID',
  `CUSTOMER_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '消费者主键ID',
  `SESSION_ID` char(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '如果该用户退出,该Session_id对应的购物车中所有记录都将被删除',
  `GOODS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品ID',
  `GOODS_SN` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品的唯一货号',
  ...
  `GOODS_ATTR` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '商品属性,JSON形式',
  `GOODS_AMOUNT` int DEFAULT NULL COMMENT '加入购物车商品数量',
  `MARKET_PRICE` int DEFAULT NULL COMMENT '市场价(分)',
  `SHOP_PRICE` int DEFAULT NULL COMMENT '本店价(分)',
  `REAL_BUY_PRICE` int NOT NULL COMMENT '实际购买价格(分)',
  `IS_OPEN_SALE` tinyint(1) DEFAULT '0' COMMENT '是否开售 1是 0否',
  `PARENT_GOODS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '该商品的父商品ID,没有该值为0,有的话那该商品就是该id的配件',
  `IS_GIFT` smallint DEFAULT NULL COMMENT '是否赠品 0否;1其他(参与活动的活动ID等)',
...
CREATE TABLE `sys_dict` (
  ...
  `VALUE` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '字典值',
  `KEYWORD` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '类型（KEY)',
  `UP_ID` int DEFAULT NULL COMMENT '上级ID根节点默认-1',
  `DIC_TYPE` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '字典类型',
  `STATUS` int DEFAULT '1' COMMENT '状态 0无效1有效',
  `OPERATOR_ID` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '操作人ID',
  `OPERATOR_NAME` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '操作人名称',
...
CREATE TABLE `sys_menu` (
  ...
  `PERMS` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '授权(多个用逗号分隔)',
  `TYPE` int DEFAULT NULL COMMENT '类型 0：目录 1：菜单 2：按钮',
  `ICON` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '菜单图标',
  `ORDER_NUM` int DEFAULT NULL COMMENT '排序',
  `ROUTER_NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '路由名称',
  `ROUTER_PATH` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '路由路径',
  PRIMARY KEY (`MENU_ID`)
...
CREATE TABLE `sys_role` (
  ...
  `DEPT_NAME` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '所属部门',
...
CREATE TABLE `sys_user` (
  `USER_ID` bigint NOT NULL AUTO_INCREMENT COMMENT '后台用户主键ID',
  `USER_NAME` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户名',
  `PASSWORD` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '密码',
  `REAL_NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户真实姓名',
  ...
  `MOBILE` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '手机号',
  `STATUS` tinyint NOT NULL DEFAULT '1' COMMENT '状态  0：禁用   1：正常',
  `DEPT_NAME` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '所属部门',
  `CREATE_TIME` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `CREATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建者',
  `UPDATE_TIME` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `UPDATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '更新者',
...
CREATE TABLE `w_goods` (
  `WP_ID` int NOT NULL AUTO_INCREMENT COMMENT '商品库存ID',
  `GOODS_ID` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品ID',
  `WH_ID` int NOT NULL COMMENT '仓库ID',
  `CURRENT_CNT` int DEFAULT '1' COMMENT '当前商品数量',
  `LOCK_CNT` int DEFAULT '1' COMMENT '当前占用数量',
  `INTRANSIT_CNT` int DEFAULT '0' COMMENT '在途数量',
  `AVERAGE_COST` int DEFAULT '0' COMMENT '移动加权成本',
  `MODIFIED_TIME` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
  PRIMARY KEY (`WP_ID`)
...
CREATE TABLE `w_ship_info` (
  `SHIP_ID` int NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `SHIP_NAME` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '物流公司名称',
  `SHIP_CONTACT` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '物流公司联系人',
  `TELPHONE` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '物流公司联系电话',
  `PRICE` int DEFAULT NULL COMMENT '配送价格（分）',
  `MODIFIED_TIME` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
  PRIMARY KEY (`SHIP_ID`)
...
CREATE TABLE `w_warehouse_info` (
  `WH_ID` int NOT NULL AUTO_INCREMENT COMMENT '仓库ID',
  `WH_SN` char(5) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '仓库编码',
  `WH_NAME` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '仓库名称',
  `WH_PHONE` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '仓库联系电话',
  `CONTACT` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '仓库联系人',
  `PROVINCE` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '省份',
  `CITY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '城市',
  `DISTRICT` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '城市中的区域',
  `ADDRESS` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '仓库地址',
